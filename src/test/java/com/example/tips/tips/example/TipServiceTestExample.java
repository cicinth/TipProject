package com.example.tips.tips.example;

import com.example.tips.tips.Tip.TipRequest;
import com.example.tips.tips.Tip.TipService;

public class TipServiceTestExample {

    private TipService tipService = new TipService();

    public static void main(String[] args){
        TipServiceTestExample test = new TipServiceTestExample();
        test.runTests();
    }
